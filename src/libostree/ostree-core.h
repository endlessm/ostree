 ...
 * @OSTREE_OBJECT_TYPE_COMPAT_SIG: Toplevel object, refers to legacy gpg signature
 *
...
typedef enum {
  ...
  OSTREE_OBJECT_TYPE_COMPAT_SIG = 6     /* .sig */
} OstreeObjectType;
 ...
 */
#define OSTREE_OBJECT_TYPE_LAST OSTREE_OBJECT_TYPE_COMPAT_SIG

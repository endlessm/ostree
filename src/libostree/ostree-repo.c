...
gboolean ostree_repo_verify_commit (OstreeRepo   *self,
                                    ...
                                    GError      **error)
{
  gs_unref_object OstreeGpgVerifier *verifier = ostree_gpg_verifier_new ();
  gs_unref_object GFile *commit_path = NULL;
  gs_unref_object GFile *sig_path = NULL;
  gs_free gchar *commit_filename;
  gs_free gchar *signature_filename;
  ...
  if (extra_keyring != NULL)
    ostree_gpg_verifier_add_keyring (verifier, extra_keyring, NULL);
  ostree_gpg_verifier_add_keyring_dir (verifier, keyringdir, NULL);
  ...
  return ostree_gpg_verifier_check_signature (verifier, commit_path, sig_path,
      NULL, error);
}
